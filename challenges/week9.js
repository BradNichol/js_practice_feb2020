...
const isItPrime = n => {
  ...
  // catches 1 and negative values
  if (n < 2) return false;

  /*Using trial by division.
  Most primes above 2 are odd
  Only need to check up to sqr root of n.
...
const areWeCovered = (staff, day) => {
  ...
  let staffCount = 0; 
  staff.forEach((e) => {
    if (e.rota.includes(day)) staffCount++;
  });
